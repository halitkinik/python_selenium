...
class TestLogOut():
  ...
  def test_logOut(self):
    ...
    self.driver.find_element(By.XPATH, "//div[@id=\'menu_button_container\']/div/div/div/button").click()
    self.driver.find_element(By.XPATH, "//div[@id=\'menu_button_container\']/div/div[2]/div/nav/a[3]").click()
